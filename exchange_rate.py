...
#
#
# print(f'Валюта: {info_USD[0]}')
# print(f'Стоимость 1$ (руб): {info_USD[8]}')
# if float(info_USD[8]) > 70:
#     print('Рекомендация к покупке: недёшево, но можно закупиться')
# elif float(info_USD[8]) > 80:
#     print('Рекомендация к покупке: ждёмс снижения')
# elif float(info_USD[8]) > 100:
#     print('Рекомендация к покупке: нам пиздец!')
# elif float(info_USD[8]) < 70:
#     print('Рекомендация к покупке: берём бакс на все бабки!!!')
#
# print('---------------------------------------------------------------')
...
#
# print(f'Валюта: Лари')
# print(f'Стоимость 1 лари (руб): {info_lari[0]}')
#
# if float(info_lari[0]) > 24:
#     print('Рекомендация к покупке: недёшево, но можно закупиться')
# elif float(info_lari[0]) > 27:
#     print('Рекомендация к покупке: ждёмс снижения')
# elif float(info_lari[0]) > 30:
#     print('Рекомендация к покупке: нам пиздец!')
# elif float(info_lari[0]) < 21:
#     print('Рекомендация к покупке: берём лари на все бабки!!!')
#
